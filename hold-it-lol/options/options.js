...
const tabs = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'fullscreen-evidence', title: 'Fullscreen in court record', description: 'Mention full-screen evidence from the court record.', preview: 'previews/placeholder.png' },
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'pose-icon-maker', title: 'Pose icon maker', description: 'Add pose icons to characters that lack them using an in-courtroom editor.', preview: 'previews/placeholder.png' },
            { key: 'export-cc-images', title: 'Custom character archiver', description: 'Download and preserve character images. (Warning: downloads will lag and may disconnect your current courtroom page.)', preview: 'previews/placeholder.png' },
        ],
    },
    {
        title: 'Music Packs',
